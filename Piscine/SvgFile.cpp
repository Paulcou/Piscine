...
void SvgFile::addEllipse(double x, double y, double rx, double ry, double opacity, std::string color)
{
    m_ostrm << "<ellipse "
            << attrib("cx", x)
            << attrib("cy", y)
...
void SvgFile::addRect2(double x1, double y1, double x2, double y2,
                       double x3, double y3,
